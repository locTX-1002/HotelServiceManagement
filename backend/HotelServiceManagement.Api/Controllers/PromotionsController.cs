...
namespace HotelServiceManagement.Api.Controllers
{
    ...
    public class PromotionsController : ControllerBase
    {
        ...
        {
            return ToActionResult(await _promotionService.GetAllAsync());
        }

        [HttpGet("{id:int}")]
        public async Task<IActionResult> GetById(int id)
        {
            return ToActionResult(await _promotionService.GetByIdAsync(id));
        }
        ...
        {
            return ToActionResult(await _promotionService.UpdateAsync(id, request));
        }
