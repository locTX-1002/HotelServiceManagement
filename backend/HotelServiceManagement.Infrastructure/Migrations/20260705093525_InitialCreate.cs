        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Reservations_DateRange", "[CheckOutDate] > [CheckInDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceOrderDetails", x => x.DetailId);
                    table.CheckConstraint("CK_ServiceOrderDetails_Quantity", "[Quantity] > 0");
                    table.ForeignKey(
