...
// Trang dat lai mat khau tu link trong email (?token=...) - noi tiep luong "Quen mat khau" o LoginPage.
export default function ResetPasswordPage() {
  ...
  const onSubmit = (e) => {
    ...
    client
      ...
      .then(() => setDone(true))
      .catch((err) => {
        if (err.response?.status === 401) setError('Liên kết đã hết hạn hoặc không hợp lệ. Hãy yêu cầu gửi lại từ trang đăng nhập.')
