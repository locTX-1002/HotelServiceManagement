...
public sealed class HousekeepingRequestService : IHousekeepingRequestService
{
    ...
    {
        if (AppSession.RoleName is not (RoleNames.Manager or RoleNames.ServiceStaff)) return ServiceResult<HousekeepingRequest>.Failure("Bạn không có quyền xử lý yêu cầu.");
