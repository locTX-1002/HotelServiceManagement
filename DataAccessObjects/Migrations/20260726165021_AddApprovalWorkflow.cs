        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRequests_RequestType_TargetId_Status",
                table: "ApprovalRequests",
                columns: new[] { "RequestType", "TargetId", "Status" });
