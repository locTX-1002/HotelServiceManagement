...
namespace DataAccessObjects.Migrations
{
    ...
    [Migration("20260728170000_LinkInvoicePromotionAndPersistDiscountBreakdown")]
    partial class LinkInvoicePromotionAndPersistDiscountBreakdown
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObjects.Entities.ApprovalRequest", b =>
                {
                    ...
                    b.Property<int?>("RequestedByGuestId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApprovalRequests", t =>
                        {
                            t.HasCheckConstraint("CK_ApprovalRequest_Requester", "([RequestedByUserId] IS NOT NULL AND [RequestedByGuestId] IS NULL) OR ([RequestedByUserId] IS NULL AND [RequestedByGuestId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Entities.Invoice", b =>
                {
                    ...
                    b.Property<bool>("IsVipDiscountApplied")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.ToTable("Invoices", t =>
                        {
                            t.HasCheckConstraint("CK_Invoice_ManualDiscountAmount_NonNegative", "[ManualDiscountAmount] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Entities.ApprovalRequest", b =>
                {
                    b.HasOne("BusinessObjects.Entities.Guest", "RequestedByGuest")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessObjects.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("BusinessObjects.Entities.Promotion", "Promotion")
                        .WithMany("Invoices")
